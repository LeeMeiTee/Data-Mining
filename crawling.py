...
def connect_mail(username, password):
    global server
    server = smtplib.SMTP('mailsecure2.zonecybersite.com', 587)
    server.ehlo()
    server.starttls()
...
def send_email(msg):
    ...
    message['From'] = 'clientservices@squirrelsave.com.sg'
    message['to'] = 'teng.yee.hau@gmail.com'
    server.sendmail('clientservices@squirrelsave.com.sg', 'teng.yee.hau@gmail.com', msg)
...
for i in range(8):    
    ...
    dep_country_chooser('Kuala Lumpur')
    arrival_country_chooser('Penang')
    dep_date_chooser('03', '13', '2020')
    return_date_chooser('03', '31', '2020')
    search()
    compile_data()
    ...
    create_msg()
    #connect_mail('clientservices@squirrelsave.com.sg','Squirrel.8263')
    #send_email(msg)
    print('Email sent!')
